...
namespace FTPUpDownApp
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            //Set initial values for checkboxes and other elements
            InitializeComponent();
        ...
        //Display message Download Complete or Upload Complete
        ...
        //Donload/Upload button
        private void button1_Click_1(object sender, EventArgs e)
        {
            if (checkup.Checked == true)
            {
                //upload to server with details from the form
            ...
            //download file from specified ftp to a hardcoded local drive location
            if (checkdown.Checked == true)
            {
                Username = textBox1.Text;
                Password = textBox2.Text;
                ...
                path = @"C:\Users\IMB_Polareyez\Desktop\";
                localdest = path + @"" + Filename;
                Fullname = Server + @"/" + Filename;
            }

            //Start the Background worker and wait a little to start it.
            Thread.Sleep(1000);
            backgroundWorker1.RunWorkerAsync();  //initiate the background worker
            Thread.Sleep(1000);
        }
